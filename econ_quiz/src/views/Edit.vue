        ...
        <form @submit.prevent="create" class="mt-4 md:mt-6 mx-4 md:grid md:grid-cols-2 gap-x-4 gap-y-6 items-center text-lg max-md:text-base">
            ...
            <div ref="dropdownMenu1" class="col-span-1">
                ...
                <div v-show="isOpen1" class="mt-4 space-y-2">
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="indicator1" class="cursor-pointer" name="indicator" value="economic" v-model="quizInfo.indicator" />
                        <label class="pl-2 cursor-pointer" for="indicator1">economic</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="indicator2" class="cursor-pointer" name="indicator" value="demographic" v-model="quizInfo.indicator" />
                        <label class="pl-2 cursor-pointer" for="indicator2">demographic</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="indicator3" class="cursor-pointer" name="indicator" value="other" v-model="quizInfo.indicator" />
            ...
            <div ref="dropdownMenu2" class="col-span-1">
                ...
                <div v-show="isOpen2" class="mt-4 space-y-2">
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="display1" class="cursor-pointer" name="display" value="smallNums" v-model="quizInfo.display" />
                        <label class="pl-2 cursor-pointer" for="display1">smallNums</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="display2" class="cursor-pointer" name="display" value="smallNumsPercentages" v-model="quizInfo.display" />
                        <label class="pl-2 cursor-pointer" for="display2">smallNumsPercentages</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="display3" class="cursor-pointer" name="display" value="largeNums" v-model="quizInfo.display" />
                        <label class="pl-2 cursor-pointer" for="display3">largeNums</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="display4" class="cursor-pointer" name="display" value="largeNumsDollars" v-model="quizInfo.display" />
            ...
            <div ref="dropdownMenu3" class="col-span-1">
                ...
                <div v-show="isOpen3" class="mt-4 space-y-2">
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="cannotOver1001" class="cursor-pointer" name="cannotOver100" :value="true" v-model="quizInfo.cannotOver100" />
                        <label class="pl-2 cursor-pointer" for="cannotOver1001">true</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="cannotOver1002" class="cursor-pointer" name="cannotOver100" :value="false" v-model="quizInfo.cannotOver100" />
            ...
            <div ref="dropdownMenu4" class="col-span-1">
                ...
                <div v-show="isOpen4" class="mt-4 space-y-2">
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="cannotBelow01" class="cursor-pointer" name="cannotBelow0" :value="true" v-model="quizInfo.cannotBelow0" />
                        <label class="pl-2 cursor-pointer" for="cannotBelow01">true</label>
                    </div>
                    <div class="flex items-center cursor-pointer">
                        <input type="radio" id="cannotBelow02" class="cursor-pointer" name="cannotBelow0" :value="false" v-model="quizInfo.cannotBelow0" />
